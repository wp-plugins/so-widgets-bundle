...
abstract class SiteOrigin_Widget extends WP_Widget {
	...
	function enqueue_scripts(){
		...
		if( !wp_script_is('siteorigin-widget-admin') ) {
			...
			wp_enqueue_media();
			wp_enqueue_script( 'siteorigin-widget-admin', plugin_dir_url(SOW_BUNDLE_BASE_FILE).'base/js/admin.min.js', array( 'jquery', 'jquery-ui-sortable', 'editor' ), SOW_BUNDLE_VERSION, true );
